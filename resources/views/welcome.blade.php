        ...
        <div class="row align-items-center gy-3">
          ...
          <div class="col-12 col-md-3 text-center text-md-start">
            <div class="flight-point">
              <h6><i class="fa-solid fa-plane-departure text-primary me-1"></i>{{ $origin->city ?? '' }}</h6>
              <span>({{ is_array($f) ? $f['origin'] : $f->origin }})</span>
            </div>
          </div>
          ...
          <div class="col-12 col-md-3 text-center text-md-end">
            <div class="flight-point">
              <h6><i class="fa-solid fa-plane-arrival text-success me-1"></i>{{ $arrival->city ?? '' }}</h6>
              <span>({{ is_array($f) ? $f['destination'] : $f->destination }})</span>
            </div>
          </div>

          <!-- 🎟️ Button -->
          <div class="col-12 col-md-3 mt-3 text-center">
            <a href="{{ route('routes.view', is_array($f) ? $f['id'] : $f->id) }}" class="select-btn">
              SELECT FLIGHT
            </a>
          </div>
        </div>
