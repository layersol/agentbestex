                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4>Selected Route :   {{ ($flights[0]['origin'].' - '.$flights[0]['destination']) }}</h4>
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                          <!-- Top bar: button on the right -->
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="m-0">Flight List</h5>
            <a href="{{ route('admin.gfares.create', $flights[0]['route_id']) }}" class="btn btn-primary">
                Add Flight
            </a>
        </div>
                                                                ...
                                                                <thead>
                                                                    <tr role="row">
                                                                        ...
                                                                        <th class="sorting" tabindex="0"
                                                                            ...
                                                                            colspan="1"
                                                                            aria-label="Age: activate to sort column ascending"
                                                                            style="">Adult Price</th>
                                                                             <th class="sorting" tabindex="0"
                                                                            aria-controls="dom-jqry" rowspan="1"
                                                                            colspan="1"
                                                                            aria-label="Age: activate to sort column ascending"
                                                                            style="">Child Price</th>
                                                                             <th class="sorting" tabindex="0"
                                                                            aria-controls="dom-jqry" rowspan="1"
                                                                            colspan="1"
                                                                            aria-label="Age: activate to sort column ascending"
                                                                            style="">Infant Price</th>
                                                                             <th class="sorting" tabindex="0"
                                                                            aria-controls="dom-jqry" rowspan="1"
                                                                            colspan="1"
                                                                            aria-label="Age: activate to sort column ascending"
