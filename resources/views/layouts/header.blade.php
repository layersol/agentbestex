...
<head>
    ...
    <script type="javascript" src="{{asset('assets/js/jquery.js')}}"></script>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/agent.css')}}">
        ...
        <div class="container">
            ...
            <div class="d-flex">
                <a href="http://agentbestex.com/" class="fadeout navbar-brand m-0 py-2 px-2 rounded-2">
                    <img class="logo p-1 rounded" style="max-width:180px;max-height:74px;" src="{{asset('assets/img/logo.webp')}}" alt="logo">
                </a>
            </div>
                    ...
                    <!-- SEARCHES -->
                        ...
                        $(document).ready(function() {
                            ...
                            <a class="rounded-4 bg-light nav-link dropdown-toggle btn btn-outline-secondary px-0 ps-3 text-center d-flex align-items-center justify-content-center gap-1 border"
                                href="{{ route('login') }}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
